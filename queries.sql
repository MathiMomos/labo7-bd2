--Para todos los ejercicios tomamos en cuenta que el servidor puede imprimir mensajes
SET SERVEROUTPUT ON
...
-- En la tabla P (Partes) se menciona que asumimos que los pesos estan en libras
-- Segun lo que busque en Google la conversión de libras a gramos es de que 1 libra equivale a 453.592 gramos
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Mínima: ' || v_min || ' | Máxima: ' || v_max);
END;
/
